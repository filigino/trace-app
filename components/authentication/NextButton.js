...
class Main extends React.Component {
    nextSignupScreen() {
        ...
        } else if (currentScreenName === 'Sex' && this.props.nextButton.active) {
            const {sex} = params
        ...
        } else if (currentScreenName === 'Ethnicity' && this.props.nextButton.active) {
    ...
    render() {
        return (
            <View style={[
                this.props.styles.nextButtonPosition,
                {opacity: this.props.nextButton.visible ? 1 : 0}
            ]}>
                <TouchableOpacity
                    onPress={() => this.nextSignupScreen()}
                    activeOpacity={this.props.nextButton.opacity}
                    style={[this.props.styles.roundButton, {backgroundColor: this.props.nextButton.color}]}
                >
